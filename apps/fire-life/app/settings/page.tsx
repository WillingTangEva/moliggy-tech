      ...
      <Tabs defaultValue="profile" className="w-full">
        <TabsList className="mb-8 grid w-full grid-cols-4">
          <TabsTrigger value="profile" className="flex items-center gap-2">
            ...
            <span className="sm:inline hidden">个人资料</span>
          </TabsTrigger>
          <TabsTrigger value="security" className="flex items-center gap-2">
            <ShieldCheck className="h-4 w-4" />
            <span className="sm:inline hidden">安全设置</span>
          </TabsTrigger>
          <TabsTrigger value="notifications" className="flex items-center gap-2">
            <Bell className="h-4 w-4" />
            <span className="sm:inline hidden">通知偏好</span>
          </TabsTrigger>
          <TabsTrigger value="data" className="flex items-center gap-2">
            <Database className="h-4 w-4" />
            <span className="sm:inline hidden">数据管理</span>
          </TabsTrigger>
        </TabsList>
                ...
                <div className="space-y-2">
                  <div className="flex justify-between items-center">
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">上海 · 当前设备</p>
                    </div>
                    <Button variant="outline" size="sm" disabled>当前</Button>
                  </div>
                  
                  <div className="flex justify-between items-center">
                    <div>
                      <p className="font-medium">iPhone 13 - Safari</p>
                      <p className="text-sm text-muted-foreground">上海 · 最后登录于 2小时前</p>
                    </div>
                  ...
                  <div className="flex justify-between items-center">
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">北京 · 最后登录于 2天前</p>
                    </div>
                    <Button variant="outline" size="sm">登出</Button>
                  </div>
                </div>
            ...
            <CardContent className="space-y-6">
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between border p-4 rounded-md">
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">所有个人数据和财务信息</p>
                    </div>
                  ...
                  <div className="flex items-center justify-between border p-4 rounded-md">
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">资产、退休规划和预测信息</p>
                    </div>
                    <Button variant="outline">
                      <Download className="mr-2 h-4 w-4" />
                      导出
                  ...
                  <div className="flex items-center justify-between border p-4 rounded-md">
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">账户信息和个人设置</p>
                    </div>
                    <Button variant="outline">
                      <Download className="mr-2 h-4 w-4" />
                      导出
              ...
              <div className="space-y-4">
                ...
                <div className="bg-blue-50 border border-blue-200 p-4 rounded-md flex items-start">
                  <HelpCircle className="text-blue-500 mr-4 h-6 w-6 flex-shrink-0 mt-1" />
                  <div>
                    <h4 className="font-medium text-blue-800 mb-1">数据隐私说明</h4>
                    <p className="text-sm text-blue-700">
                      我们重视您的数据隐私。所有数据均加密存储，并且仅用于提供您请求的服务。
                      我们不会将您的个人数据出售给第三方。您可以随时删除您的账户和相关数据。
                    </p>
                    <Button variant="link" className="text-blue-700 p-0 h-auto mt-1">查看隐私政策</Button>
                  </div>
                </div>
              </div>
