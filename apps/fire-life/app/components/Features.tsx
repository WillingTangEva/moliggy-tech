            ...
            <TabsList className="bg-muted/50 flex h-auto flex-col space-y-1 p-1 md:w-64">
              ...
              >
                ...
                <div className="text-left">
                  ...
                  <div className="text-muted-foreground text-xs">一目了然的财务概览</div>
                </div>
              </TabsTrigger>
              <TabsTrigger
                value="planner"
              ...
              >
                ...
                <div className="text-left">
                  ...
                  <div className="text-muted-foreground text-xs">定制专属计划</div>
                </div>
              </TabsTrigger>
              <TabsTrigger
                value="projection"
              ...
              >
                ...
                <div className="text-left">
                  ...
                  <div className="text-muted-foreground text-xs">动态模拟未来财务</div>
                </div>
              </TabsTrigger>
              <TabsTrigger
              ...
              >
                ...
                <div className="text-left">
                  ...
                  <div className="text-muted-foreground text-xs">优化资产配置策略</div>
                </div>
              </TabsTrigger>
            </TabsList>
                  ...
                  <CardContent className="py-6">
                    ...
                    <div className="mt-6 grid grid-cols-1 gap-4 sm:grid-cols-2">
                      <div className="bg-muted/30 rounded-lg p-4">
                        ...
                        <p className="text-muted-foreground text-sm">监控您的净资产增长趋势</p>
                      </div>
                      <div className="bg-muted/30 rounded-lg p-4">
                        <h4 className="mb-1 font-medium">退休进度计算</h4>
                        <p className="text-muted-foreground text-sm">查看距离财务自由的进度百分比</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
                  ...
                  <CardContent className="py-6">
                    ...
                    <div className="mt-6 grid grid-cols-1 gap-4 sm:grid-cols-2">
                      <div className="bg-muted/30 rounded-lg p-4">
                        ...
                        <p className="text-muted-foreground text-sm">优化您的投资组合以实现目标</p>
                      </div>
                      <div className="bg-muted/30 rounded-lg p-4">
                        <h4 className="mb-1 font-medium">多场景规划</h4>
                        <p className="text-muted-foreground text-sm">创建和比较不同的退休场景</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
                  ...
                  <CardContent className="py-6">
                    ...
                    <div className="mt-6 grid grid-cols-1 gap-4 sm:grid-cols-2">
                      <div className="bg-muted/30 rounded-lg p-4">
                        ...
                        <p className="text-muted-foreground text-sm">分析各种市场情景下的退休成功率</p>
                      </div>
                      <div className="bg-muted/30 rounded-lg p-4">
                        <h4 className="mb-1 font-medium">互动式图表</h4>
                        <p className="text-muted-foreground text-sm">调整参数并实时查看影响</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
                  ...
                  <CardContent className="py-6">
                    ...
                    <div className="mt-6 grid grid-cols-1 gap-4 sm:grid-cols-2">
                      <div className="bg-muted/30 rounded-lg p-4">
                        ...
                        <p className="text-muted-foreground text-sm">提供合法节税策略建议</p>
                      </div>
                      <div className="bg-muted/30 rounded-lg p-4">
                        <h4 className="mb-1 font-medium">支出分析</h4>
                        <p className="text-muted-foreground text-sm">找出节约机会，延长退休资金寿命</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
