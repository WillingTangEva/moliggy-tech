...
import { Download, Save, UserRound, ShieldCheck, Bell, Database, Trash2, HelpCircle } from 'lucide-react';
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="space-y-1">
                    ...
                    <Input id="phone" defaultValue="13812345678" />
                  </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="space-y-1">
                    ...
                    <Input id="birth" type="date" defaultValue="1985-01-15" />
                  </div>
                  <div className="space-y-1">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  <div className="space-y-0.5">
                    ...
                    <p className="text-muted-foreground text-sm">启用深色模式以减少眼睛疲劳</p>
                  </div>
                  <Switch id="dark-mode" />
                </div>
              </div>
        ...
        <TabsContent value="security">
          <Card>
            <CardHeader>
              ...
              <CardDescription>管理密码和账户安全选项</CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              <div className="space-y-4">
              ...
              <div className="space-y-4">
                <h3 className="text-lg font-medium">双重验证</h3>

                <div className="flex items-center justify-between">
                  <div className="space-y-0.5">
                    <Label htmlFor="2fa">两步验证</Label>
                    <p className="text-muted-foreground text-sm">启用两步验证以提高账户安全性</p>
                  </div>
                  <Switch id="2fa" />
                </div>
                ...
                <div className="flex items-center justify-between">
                  <div className="space-y-0.5">
                    <Label htmlFor="login-alert">登录提醒</Label>
                    <p className="text-muted-foreground text-sm">在新设备登录时发送邮件通知</p>
                  </div>
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-muted-foreground text-sm">上海 · 当前设备</p>
                    </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-muted-foreground text-sm">上海 · 最后登录于 2小时前</p>
                    </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-muted-foreground text-sm">北京 · 最后登录于 2天前</p>
                    </div>
                    <Button variant="outline" size="sm">
                      登出
                    </Button>
                ...
                <Button variant="secondary">登出所有其他设备</Button>
              </div>
            </CardContent>
          </Card>
        </TabsContent>
        ...
        <TabsContent value="notifications">
          <Card>
            <CardHeader>
              ...
              <CardDescription>自定义您希望接收的通知类型和频率</CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              <div className="space-y-4">
                ...
                <div className="grid gap-2">
                  <RadioGroup defaultValue="both">
                    <div className="flex items-center space-x-2">
                      ...
                      <Label htmlFor="both">电子邮件和短信</Label>
                    </div>
                    <div className="flex items-center space-x-2">
                      <RadioGroupItem value="email" id="email" />
                      <Label htmlFor="email">仅电子邮件</Label>
                    </div>
                    <div className="flex items-center space-x-2">
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between">
                    <div className="space-y-0.5">
                      <Label>账户安全提醒</Label>
                      <p className="text-muted-foreground text-sm">登录提醒、密码更改、账户活动等</p>
                    </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="space-y-0.5">
                      <Label>财务目标提醒</Label>
                      <p className="text-muted-foreground text-sm">储蓄目标达成、退休准备度变化等</p>
                    </div>
                    <Switch defaultChecked />
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="space-y-0.5">
                      <Label>定期报告</Label>
                      <p className="text-muted-foreground text-sm">每月财务状况摘要、退休规划更新等</p>
                    </div>
                    <Switch defaultChecked />
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="space-y-0.5">
                      <Label>新功能公告</Label>
                      <p className="text-muted-foreground text-sm">平台新功能、服务更新等信息</p>
                    </div>
                    <Switch />
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="space-y-0.5">
                      <Label>营销信息</Label>
                      <p className="text-muted-foreground text-sm">促销活动、合作伙伴优惠等</p>
                    </div>
                    <Switch />
                  </div>
                </div>
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-1">
                  <Label htmlFor="report-frequency">财务报告频率</Label>
        ...
        <TabsContent value="data">
          <Card>
            <CardHeader>
              ...
              <CardDescription>管理您的个人数据和账户信息</CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between rounded-md border p-4">
                    <div>
                      <p className="font-medium">完整数据包</p>
                      <p className="text-muted-foreground text-sm">所有个人数据和财务信息</p>
                    </div>
                  ...
                  <div className="flex items-center justify-between rounded-md border p-4">
                    <div>
                      ...
                      <p className="text-muted-foreground text-sm">资产、退休规划和预测信息</p>
                    </div>
                    <Button variant="outline">
                      <Download className="mr-2 h-4 w-4" />
                      导出
                  ...
                  <div className="flex items-center justify-between rounded-md border p-4">
                    <div>
                      ...
                      <p className="text-muted-foreground text-sm">账户信息和个人设置</p>
                    </div>
                    <Button variant="outline">
                      <Download className="mr-2 h-4 w-4" />
                      导出
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start rounded-md border border-blue-200 bg-blue-50 p-4">
                  ...
                  <div>
                    <h4 className="mb-1 font-medium text-blue-800">数据隐私说明</h4>
                    <p className="text-sm text-blue-700">
                      我们重视您的数据隐私。所有数据均加密存储，并且仅用于提供您请求的服务。
                      我们不会将您的个人数据出售给第三方。您可以随时删除您的账户和相关数据。
                    </p>
                    <Button variant="link" className="mt-1 h-auto p-0 text-blue-700">
                      查看隐私政策
                    </Button>
                  </div>
                </div>
              ...
              <div className="space-y-4">
                <h3 className="text-lg font-medium text-red-600">账户删除</h3>
                ...
                <AlertDialog>
                  ...
                  <AlertDialogContent>
                    <AlertDialogHeader>
                      ...
                      <AlertDialogDescription>
                        此操作将永久删除您的账户和所有相关数据，包括个人资料、财务信息和规划数据。 删除后无法恢复。
                      </AlertDialogDescription>
                    </AlertDialogHeader>
                    <AlertDialogFooter>
