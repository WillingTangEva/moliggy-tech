    ...
    <div className="container mx-auto px-4 py-8 md:px-6 md:py-12">
      <div className="flex flex-col space-y-4 md:flex-row md:items-center md:justify-between md:space-y-0">
        <div>
          ...
          <p className="text-muted-foreground mt-1">管理您的财务计划和退休目标</p>
        </div>
        ...
        <TabsContent value="all" className="mt-4">
          {loading ? (
            ...
            <div className="rounded-lg border border-dashed p-12 text-center">
              ...
              <p className="text-muted-foreground mt-2">创建一个新计划来开始您的财务自由之旅</p>
                ...
                <Card key={plan.id} className="overflow-hidden">
                  ...
                  <CardContent>
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      <div>
                        <p className="text-muted-foreground text-sm">风险偏好</p>
                  ...
                  <CardFooter className="bg-muted/30 flex justify-between px-6 py-3">
                    <div className="flex space-x-2">
                      <Button variant="ghost" size="sm" onClick={() => router.push(`/plan/${plan.id}`)}>
                        查看
                      </Button>
                      <Button variant="ghost" size="sm" onClick={() => router.push(`/plan/save?id=${plan.id}`)}>
                        <FileEdit className="h-4 w-4" />
                      </Button>
                    </div>
                    <div className="flex space-x-2">
                      <Button variant="ghost" size="sm" onClick={() => router.push(`/forecast?planId=${plan.id}`)}>
