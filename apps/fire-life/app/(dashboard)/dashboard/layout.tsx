...
import { HomeIcon, BarChart3, Wallet, CalendarClock, Settings, LogOut } from 'lucide-react';
  ...
  return (
    <aside className="bg-card border-border fixed left-0 top-0 h-screen w-64 border-r p-4">
      ...
      <div className="absolute bottom-8 left-0 w-full px-4">
        <Button variant="outline" className="text-muted-foreground flex w-full items-center gap-2" asChild>
