          ...
          <Card>
            ...
            <CardContent>
              <div className="flex items-center justify-between">
                ...
                <span className="text-muted-foreground text-sm">目标: 100%</span>
              </div>
              ...
              <div className="mt-2 flex justify-between text-sm">
                ...
                {latestForecast && <span>目标: ¥{(latestForecast.retirement_assets / 10000).toFixed(1)}万</span>}
              </div>
            </CardContent>
          </Card>
                ...
                {latestForecast ? (
                  <>
                    <div className="text-2xl font-bold">
                      {new Date().getFullYear() + (latestForecast.retirement_age - (plans[0]?.current_age || 30))}年
                    </div>
                    <div className="text-muted-foreground text-sm">{latestForecast.retirement_age}岁</div>
                  </>
                ) : (
          ...
          <Card>
            ...
            <CardContent className="flex items-center">
              ...
              <div>
                {latestForecast ? (
                  <>
                    <div className="text-2xl font-bold">¥{latestForecast?.monthly_income?.toLocaleString() || '0'}</div>
