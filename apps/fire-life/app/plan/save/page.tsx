        ...
        try {
            ...
            const planData = {
                ...
                expected_return_rate: formData.risk_profile === 'conservative' ? 0.05 : 
                                     formData.risk_profile === 'moderate' ? 0.07 : 0.10,
                inflation_rate: 0.03,
                        ...
                        <div className="space-y-2">
                            ...
                            {assetLoading ? (
                                <div className="text-center my-8">
                                    ...
                                    <p className="mt-2 text-muted-foreground">加载资产数据...</p>
                                </div>
                            ) : assetError ? (
                                <div className="text-center my-8">
        ...
        <div className="max-w-3xl mx-auto px-4">
            <div className="mb-8 space-y-2">
                ...
                <p className="text-muted-foreground">
                    {isEditing ? '更新您的退休计划信息' : '创建一个新的退休财务规划'}
                </p>
            </div>
                    ...
                    {steps.map((step, index) => (
                        ...
                        >
                            ...
                            {index < steps.length - 1 && (
                                <div className="absolute left-0 right-0 h-[1px] bg-muted-foreground/30" style={{ width: `calc(100% - 2rem)`, left: `calc(${index * 100 / (steps.length - 1)}% + 1rem)` }} />
                            )}
                        </div>
                    ))}
                </div>
...
export default function SavePlan() {
    return (
        <div className="py-12">
            <Suspense fallback={<div className="text-center py-24"><Loader2 className="h-12 w-12 animate-spin mx-auto" /></div>}>
                <PlanForm />
            </Suspense>
        </div>
    );
