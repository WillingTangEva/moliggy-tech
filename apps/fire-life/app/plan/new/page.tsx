          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                ...
                <div className="space-y-2">
                  <Label htmlFor="retirement-age">目标退休年龄</Label>
              ...
              <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                ...
                <div className="space-y-2">
                  <Label htmlFor="income">当前月收入 (¥)</Label>
                  <Input id="income" type="number" placeholder="25000" />
                </div>
              </div>
              <div className="space-y-2">
                <Label htmlFor="risk-profile">风险承受能力</Label>
                <Select>
        ...
        {currentStep === 2 && (
          <Card>
            <CardHeader>
              ...
              <CardDescription>添加您当前拥有的各类资产</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="space-y-2">
                <Label htmlFor="bank-savings">银行储蓄 (¥)</Label>
                <Input id="bank-savings" type="number" placeholder="100000" />
              </div>
              <div className="space-y-2">
                <Label htmlFor="term-deposits">定期存款 (¥)</Label>
                <Input id="term-deposits" type="number" placeholder="200000" />
              </div>
              <div className="space-y-2">
                <Label htmlFor="stocks">股票投资 (¥)</Label>
                <Input id="stocks" type="number" placeholder="300000" />
              </div>
              <div className="space-y-2">
                <Label htmlFor="funds">基金投资 (¥)</Label>
                <Input id="funds" type="number" placeholder="200000" />
              </div>
              <div className="space-y-2">
                <Label htmlFor="real-estate">房产估值 (¥)</Label>
                <Input id="real-estate" type="number" placeholder="2000000" />
              </div>
              <div className="space-y-2">
                <Label htmlFor="other-assets">其他资产 (¥)</Label>
                <Input id="other-assets" type="number" placeholder="50000" />
              </div>
            </CardContent>
        ...
        {currentStep === 4 && (
          <Card>
            <CardHeader>
              ...
              <CardDescription>预估您当前和退休后的支出</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="space-y-2">
              ...
              <div className="space-y-2">
                ...
                <div className="grid grid-cols-1 gap-4">
                  <div className="grid grid-cols-3 gap-2">
                    <div>
                      <Label htmlFor="major-expense-1-name">支出名称</Label>
                      <Input id="major-expense-1-name" placeholder="子女教育" />
                    </div>
                    <div>
                  ...
                  <div className="grid grid-cols-3 gap-2">
                    <div>
                      <Label htmlFor="major-expense-2-name">支出名称</Label>
                      <Input id="major-expense-2-name" placeholder="环球旅行" />
                    </div>
                    <div>
