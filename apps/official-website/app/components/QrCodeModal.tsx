        ...
        <motion.div className="p-6" variants={containerVariants} initial="hidden" animate="visible" exit="exit">
          <DialogHeader>
            <motion.div variants={itemVariants}>
              <DialogTitle className="text-center text-xl font-bold">扫码咨询</DialogTitle>
            </motion.div>
          </DialogHeader>

          <motion.div className="my-4 flex justify-center" variants={itemVariants}>
          ...
          <motion.div variants={itemVariants} className="text-center">
            ...
            <p className="text-muted-foreground text-sm">或添加客服微信: moliggy-tech</p>
          </motion.div>
