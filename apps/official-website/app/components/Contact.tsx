    ...
    <section id="contact" className="bg-secondary py-20">
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <Muted className="mx-auto mt-4 max-w-2xl">无论您有任何问题或需求，我们的团队随时准备为您提供帮助</Muted>
        </motion.div>
        ...
        >
            ...
            <Card className="shadow-lg">
              ...
              <CardContent>
                <form onSubmit={handleSubmit} className="space-y-6">
                  <motion.div className="grid grid-cols-1 gap-6 md:grid-cols-2" variants={animations.formField}>
          ...
          <motion.div variants={animations.item}>
            <Card className="bg-card/50 border-primary/10 h-full shadow-lg backdrop-blur-sm">
              <CardHeader>
                <CardTitle className="text-center text-2xl font-bold">联系方式</CardTitle>
              </CardHeader>
              <CardContent>
