...
export default function Cases() {
  ...
  return (
    <section id="cases" className="bg-secondary relative overflow-hidden py-20">
      {/* 背景装饰 */}
                ...
                <Card className="border-border/40 hover:border-primary/30 h-full overflow-hidden border transition-all duration-300 hover:shadow-md">
                  <div className="bg-muted/30 group relative h-48 overflow-hidden">
                    ...
                    <motion.div
                      ...
                      transition={{ duration: 0.3 }}
                    >
                      <Button variant="secondary" className="rounded-full shadow-lg transition-shadow hover:shadow-xl">
                        查看详情
                      </Button>
                    </motion.div>
                  </div>
                  ...
                  <CardContent className="p-6">
                    ...
                    <H3 className="mb-2 mt-3 text-xl font-semibold">{item.title}</H3>
