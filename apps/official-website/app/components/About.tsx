          ...
          >
            ...
            >
              <div className="relative px-4 py-6">
                {/* 左侧引号 */}
                <div className="absolute -left-2 top-0 font-serif text-5xl text-red-500 opacity-90">"</div>
                ...
                {/* 右侧引号 */}
                <div className="absolute -right-2 bottom-0 font-serif text-5xl text-red-500 opacity-90">"</div>
              </div>
            </motion.div>
            ...
            >
              <Badge className="bg-red-600 text-white hover:bg-red-700">人工智能专家</Badge>
              <Badge className="bg-red-600 text-white hover:bg-red-700">数字化转型顾问</Badge>
              <Badge className="bg-red-600 text-white hover:bg-red-700">企业家</Badge>
            </motion.div>
          </motion.div>
        </div>
      </div>
